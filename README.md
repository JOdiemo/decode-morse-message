...
**Decode Morse message** is a ruby application to decode morse message.
...
```sh
  cd my-folder
  git clone git@github.com:JOdiemo/decode-morse-message.git
```
...
Feel free to check the [issues page](https://github.com/JOdiemo/decode-morse-message/issues).

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## ⭐️ Show your support <a name="support"></a>

If you like this project, we would appreciate if you can follow, give it a star or even fork it.
...
We would like to thank the Microverse team for the support they have given to us.
